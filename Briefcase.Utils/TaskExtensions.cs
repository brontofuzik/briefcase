...
namespace Briefcase.Utils
{
    public static class TaskExtensions
    {
        ...
        public static async Task<TNewResult> Then<TNewResult>(this Task antecedent,
        ...
        public static async Task Then<TResult>(this Task<TResult> antecedent,
            Action<TResult> continuation)
        {
            continuation(await antecedent);
        }

        public static async Task<TNewResult> Then<TResult, TNewResult>(this Task<TResult> antecedent,
        ...
        public static async Task<TNewResult> Then<TNewResult>(this Task task,
        ...
        public static async Task Then<TResult>(this Task<TResult> task,
            Func<TResult, Task> continuation)
        {
            await continuation(await task);
        }

        public static async Task<TNewResult> Then<TResult, TNewResult>(this Task<TResult> task,
